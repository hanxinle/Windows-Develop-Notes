...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Text(pDX, IDC_EDIT1, f_no1);
	DDX_Text(pDX, IDC_EDIT2, f_no2);
	DDX_Text(pDX, IDC_EDIT3, f_result);
}
...
void CaddDlg::OnBnClickedButton1()
{
	...
	GetDlgItemText (IDC_EDIT1, f_no1);
	GetDlgItemText (IDC_EDIT1, f_no2);
	double r = _tstof(f_no1) + _tstof(f_no2);
	
	f_result.Format(_T("%f"), r);
